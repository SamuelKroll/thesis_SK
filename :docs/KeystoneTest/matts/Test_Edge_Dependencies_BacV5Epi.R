...
TN <- "./Output_Testtables/BacV5Epi_TestTable.txt"
...
WT <- paste(outputFolder,"BacV5Epi_EdgeDepend_stmrsqadj.txt",sep="")
write.table(OutTable_stmrsqadj, file=WT, sep="\t")

WT <- paste(outputFolder,"BacV5Epi_EdgeDepend_slope.txt",sep="")
write.table(OutTable_slope, file=WT, sep="\t")

WT <- paste(outputFolder,"BacV5Epi_EdgeDepend_rsq.txt",sep="")
write.table(OutTable_rsq, file=WT, sep="\t")

WT <- paste(outputFolder,"BacV5Epi_EdgeDepend_adjrsq.txt",sep="")
write.table(OutTable_adjrsq, file=WT, sep="\t")

WT <- paste(outputFolder,"BacV5Epi_EdgeDepend_pval.txt",sep="")
