...
TN <- "./Output_Testtables/OtradEndo_TestTable.txt"
...
WT <- paste(outputFolder,"OtradEndo_EdgeDepend_stmrsqadj.txt",sep="")
write.table(OutTable_stmrsqadj, file=WT, sep="\t")

WT <- paste(outputFolder,"OtradEndo_EdgeDepend_slope.txt",sep="")
write.table(OutTable_slope, file=WT, sep="\t")

WT <- paste(outputFolder,"OtradEndo_EdgeDepend_rsq.txt",sep="")
write.table(OutTable_rsq, file=WT, sep="\t")

WT <- paste(outputFolder,"OtradEndo_EdgeDepend_adjrsq.txt",sep="")
write.table(OutTable_adjrsq, file=WT, sep="\t")

WT <- paste(outputFolder,"OtradEndo_EdgeDepend_pval.txt",sep="")
