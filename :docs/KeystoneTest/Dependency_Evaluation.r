...
NT <- "./Lists/Dec_Jan_1_Node_Table.csv"
NodeTable <- read.csv(file=NT, header = T, sep = ",", stringsAsFactors = F)
...
new_colnames <- unlist(lapply(new_colnames, FUN=function(x){paste("BacV5",x[1],sep="_")}))
...
new_colnames <- c("Original", new_colnames)
new_colnames <- new_colnames[-length(new_colnames)]
new_colnames <- unlist(lapply(new_colnames, FUN=function(x){paste("BacV3",x[1],sep="_")}))
...
new_colnames <- c("Original", new_colnames)
new_colnames <- new_colnames[-length(new_colnames)]
new_colnames <- unlist(lapply(new_colnames, FUN=function(x){paste("FITS2",x[1],sep="_")}))
...
new_colnames <- c("Original", new_colnames)
new_colnames <- new_colnames[-length(new_colnames)]
new_colnames <- unlist(lapply(new_colnames, FUN=function(x){paste("Ftrad",x[1],sep="_")}))
...
new_colnames <- c("Original", new_colnames)
new_colnames <- new_colnames[-length(new_colnames)]
new_colnames <- unlist(lapply(new_colnames, FUN=function(x){paste("OITS2",x[1],sep="_")}))
...
#Put the nodetable in the same order as teh points and add important vectors to points
y <- strsplit(NodeTable$name, "_", fixed = T)
NodeTable$SimpleName <- unlist(lapply(y, FUN=function(x){paste(x[2],x[3],sep="_")}))
NodeTable$WholeName <- paste(NodeTable$FromWhich, NodeTable$SimpleName, sep="_")
